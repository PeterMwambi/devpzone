            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-center p-2">
                        <div class="d-block">
                            <h3 class="text-center form-alert-heading text-nowrap">Client Registration Form</h3>
                            <p class="text-center form-alert-text mt-2">Fill in the fields bellow to register...</p>
                    ...
                    <div class="p-1">
                        <form method="post" class="clientRegistrationForm" class="w-100">
                            ...
                            <div class="form-group mt-lg-4">
                                <input type="hidden" name="mandatory-security-field" value="<?php echo Functions::encrypt("CLIENT_REGISTRATION_FORM") ?>">
                                <input type="submit" name="login" class="btn btn-lg btn-dark w-100" value="Register &raquo;">
                            </div>
                        </form>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="d-flex">
                                <div>
                                    <img src="<?php echo Config::getIcon("login") ?>" class="img-fluid icon-sm">
                                </div>
                                <div>
                                    <a href="?request=login">Click here to login</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex justify-content-end ml-3 mt-n1">
