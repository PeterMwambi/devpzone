...
<div class="container-fluid p-0 body-overlay">
    ...
    <div class="p-3 bg-light shadow-sm mt-4">
        <div class="d-flex text-dark-orange justify-content-center mt-3">
            <h3 class="mr-3">Brands We Offer</h3>
        </div>
        <div class="d-flex justify-content-center">
            <p class="text-center col-md-4">Take a look at some of the brands we offer</p>
        </div>
    </div>
    ...
    <div class="visible">
                    ...
                    <div class="col-md-8 mt-3">
                        <div class="row">
                            <?php foreach ($brands as $brand) { ?>
                                <div class="col-md-2 col-4 mb-5 mt-3">
                                    <img src="<?php echo Directories::getLocation("tools/assets/" . $brand) ?>" class="img-fluid icon-md">
                                </div>
                            <?php } ?>
                        </div>
                    </div>
        ...
        <div class="d-flex justify-content-center mb-5">
            <a class="btn btn-outline-dark bg-orange-hover round" href="?request=about#ourBrands">Find out More &raquo;</a>
        </div>
    </div>
