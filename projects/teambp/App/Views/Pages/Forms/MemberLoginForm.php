        ...
        <div class="row p-lg-5 p-md-3 p-2">
            ...
            <div class="col-lg-5 col-md-12 col-12 animate__animated animate__slideInRight">
                ...
                <div class="mt-lg-5 mx-lg-5 my-3 p-md-4 p-lg-4 p-4 border border-secondary rounded">
                    ...
                    <?php require_once(Url::GetPath("app/views/includes/components/forms/memberlogin/step2.php")) ?>
                    <?php require_once(Url::GetPath("app/views/includes/components/forms/memberlogin/step1.php")) ?>
                    <?php require_once(Url::GetPath("app/views/includes/components/alert/success.php")) ?>
