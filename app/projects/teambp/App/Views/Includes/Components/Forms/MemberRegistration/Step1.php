...
<form method="post" class="" id="registration-form-step-1">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-12 mb-3">
            <label class="mb-2"><strong>Marital status:</strong> *</label>
            <select class="form-select" name="marital-status" placeholder="">
    ...
    <div class="mb-3">
        <label for="occupation" class="mb-2"><strong>Occupation:</strong> *</label>
        <select class="form-select" name="occupation" placeholder="">
    ...
    <input type="hidden" name="form-identifier" value="<?php echo Hashing::encrypt("MEMBER_REGISTRATION_STEP_1") ?>">
