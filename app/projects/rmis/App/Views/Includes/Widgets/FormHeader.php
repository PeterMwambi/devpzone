...
<div class="form-header mb-3">
    <div class="d-flex justify-content-center">
        <h6 class="text-nowrap"><strong class="teambp__form-stepHeading">Step 1: Personal Information</strong></h6>
    </div>
    <div class="d-flex justify-content-center">
        <em class="teambp__form-helpText mb-2">Required fields are marked by *</em>
    </div>
    ...
    <?php require_once(Url::GetPath("app/views/includes/widgets/FormSpinner.php")); ?>
</div>